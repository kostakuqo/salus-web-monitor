            ...
            <div className="uta-interface main-uta">
                ...
                <div className="uta-details-container">
                    ...
                    {editMode && editedUta && (
                        <div className="edit-form">
                            ...
                            <form onSubmit={(e) => { e.preventDefault(); handleSaveEditedUta(); }}>
                                ...
                                <label>
                                    Temp Ujit Hyrje:
                                    <input type="number" value={editedUta.tempWaterIn} onChange={(e) => setEditedUta({ ...editedUta, tempWaterIn: Number(e.target.value) })} />
                                </label>
                                <label>
                                    Presioni:
                    ...
                    <div className="uta-details-grid">
                        ...
                        <div className="data-card"><h4>Temp Ujit Hyrje</h4><p>{selectedUta.tempWaterIn} °C</p></div>
                        <div className="data-card"><h4>Presioni</h4><p>{selectedUta.pressure} bar</p></div>
                    ...
                    <div className="uta-charts-buttons">
                        <button className={`chart-btn ${activeChart === "supply" ? "active" : ""}`} onClick={() => setActiveChart("supply")}><GoGraph style={{ marginRight: "4px", fontSize: "15px" }} />Temp Air Hyrje</button>
                        <button className={`chart-btn ${activeChart === "return" ? "active" : ""}`} onClick={() => setActiveChart("return")}><GoGraph style={{ marginRight: "4px" }} />Temp Air Kthim</button>
                    ...
                    <div className="uta-chart">
                        {activeChart && (
                            <div className="chart-wrapper">
                                ...
                                {activeChart === "supply" && <TemperatureChart data={[selectedUta]} dataKey="tempAirSupply" label="Temp Air Hyrje" />}
                                {activeChart === "return" && <TemperatureChart data={[selectedUta]} dataKey="tempReturn" label="Temp Air Kthim" />}
                                {activeChart === "water" && <TemperatureChart data={[selectedUta]} dataKey="tempWaterIn" label="Temp Ujit Hyrje" />}
                            </div>
                        )}
                    </div>
                </div>
